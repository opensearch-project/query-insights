...
public class TopQueriesRbacIT extends QueryInsightsRestTestCase {
    ...
    public void testRbacFilteringOnTopQueries() throws Exception {
        ...
        assertEquals(
            "In none mode, user_team_a should see same count as admin",
            adminCountNone,
            userAQueriesNone.size()
        );
        ...
        assertEquals(
            "user_team_c should see only own queries (no shared backend role with A or B)",
            Set.of(USER_TEAM_C),
            userCBrUsernames
        );
    ...
    public void testRbacFilteringOnHistoricalData() throws Exception {
        ...
        assertEquals(
            "In none mode, user_team_a should see all historical queries",
            adminHistCount,
            userAHistNone.size()
        );
    ...
    private void setupSecurityUsersAndRoles() throws IOException {
        ...
        createMapping.setJsonEntity(
            "{\"users\":[\"" + USER_TEAM_A + "\",\"" + USER_TEAM_B + "\",\"" + USER_TEAM_C + "\"]}"
        );
