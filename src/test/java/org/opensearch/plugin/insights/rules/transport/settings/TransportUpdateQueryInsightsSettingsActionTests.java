...
public class TransportUpdateQueryInsightsSettingsActionTests extends OpenSearchTestCase {
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithLatencyMetric() throws Exception {
        ...
        // Use reflection to test the private mapSettings method
        Method mapSettingsMethod = TransportUpdateQueryInsightsSettingsAction.class.getDeclaredMethod(
            "mapSettings",
            Map.class,
            Settings.Builder.class
        );
        mapSettingsMethod.setAccessible(true);
        mapSettingsMethod.invoke(action, settings, builder);
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithCpuAndMemoryMetrics() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithGroupingSettings() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithExporterSettings() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithNestedPersistentStructure() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithAllMetricTypes() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testMapSettingsWithComplexMixedSettings() throws Exception {
        Map<String, Object> settings = new HashMap<>();
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testProcessMetricSettingsWithPartialFields() throws Exception {
        Settings.Builder builder = Settings.builder();
        ...
        Method processMetricSettingsMethod = TransportUpdateQueryInsightsSettingsAction.class.getDeclaredMethod(
            "processMetricSettings",
            String.class,
            Map.class,
            Settings.Builder.class
        );
        processMetricSettingsMethod.setAccessible(true);
        processMetricSettingsMethod.invoke(action, "latency", latencySettings, builder);
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testProcessMetricSettingsWithAllFields() throws Exception {
        Settings.Builder builder = Settings.builder();
        ...
        processMetricSettingsMethod.setAccessible(true);
        processMetricSettingsMethod.invoke(action, "cpu", cpuSettings, builder);
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testProcessSettingsIteratesThroughAllMetrics() throws Exception {
        Map<String, Object> settings = new HashMap<>();
        ...
        Method processSettingsMethod = TransportUpdateQueryInsightsSettingsAction.class.getDeclaredMethod(
            "processSettings",
            Map.class,
            Settings.Builder.class
        );
        processSettingsMethod.setAccessible(true);
        processSettingsMethod.invoke(action, settings, builder);
     ...
     * Uses reflection to access private method for white-box testing.
     */
    public void testProcessSettingsWithGroupingAndExporter() throws Exception {
        Map<String, Object> settings = new HashMap<>();
