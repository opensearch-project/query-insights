...
public class QueryInsightsPlugin extends Plugin implements ActionPlugin, TelemetryAwarePlugin {
    ...
    public List<Setting<?>> getSettings() {
        return List.of(
            ...
            QueryInsightsSettings.TOP_N_FAILURE_QUERIES_ENABLED,
            QueryInsightsSettings.TOP_N_FAILURE_QUERIES_SIZE,
            QueryInsightsSettings.TOP_N_FAILURE_QUERIES_WINDOW_SIZE,
