...
public class LiveQueries extends BaseNodeResponse implements ToXContentFragment {
    ...
    private final List<LiveQueryInfo> liveQueries;
     ...
     */
    public LiveQueries(final DiscoveryNode node, final List<LiveQueryInfo> liveQueries) {
        super(node);
    ...
    public LiveQueries(final StreamInput in) throws IOException {
        super(in);
        liveQueries = in.readList(LiveQueryInfo::new);
    }
     ...
     */
    public List<LiveQueryInfo> getLiveQueries() {
        return liveQueries;
    }
    ...
    public XContentBuilder toXContent(final XContentBuilder builder, final Params params) throws IOException {
        ...
        for (LiveQueryInfo query : liveQueries) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(liveQueries, that.liveQueries);
    }
