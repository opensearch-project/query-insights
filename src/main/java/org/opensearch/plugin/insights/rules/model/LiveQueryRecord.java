...
public class LiveQueryRecord implements Writeable, ToXContentObject {
    ...
    private final TaskRecord coordinatorTask;
    private final List<TaskRecord> shardTasks;
    ...
    public LiveQueryRecord(
        ...
        long totalCpu,
        long totalMemory,
        TaskRecord coordinatorTask,
        List<TaskRecord> shardTasks
    ) {
    ...
    public LiveQueryRecord(StreamInput in) throws IOException {
        ...
        this.coordinatorTask = in.readOptionalWriteable(TaskRecord::new);
        this.shardTasks = in.readList(TaskRecord::new);
    }
    ...
    public XContentBuilder toXContent(XContentBuilder builder, Params params) throws IOException {
        ...
        for (TaskRecord task : shardTasks) {
    ...
    public TaskRecord getCoordinatorTask() {
        return coordinatorTask;
    }

    public List<TaskRecord> getShardTasks() {
        return shardTasks;
    }
}
